...
const Productnotavailable = () => {
    return (
        <div className="h-[80vh] flex flex-col justify-center items-center space-y-11">
            <div className="flex items-center">
                <h1 className="text-9xl text-red-600">OH NO!</h1>
                <p className="text-3xl">But that's okay</p>
            </div>
